/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8786941681e9e1e068a0465e595cd0d8)
// Runtime types generated with workerd@1.20251217.0 2025-09-02 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "GameAgent" | "LobbyAgent";
	}
	interface Env {
		GameAgent: DurableObjectNamespace<import("./src/server").GameAgent>;
		LobbyAgent: DurableObjectNamespace<import("./src/server").LobbyAgent>;
		AI: Ai;
		HUMAN_VS_AI_WORKFLOW: Workflow<Parameters<import("./src/server").HumanVsAIWorkflow['run']>[0]['payload']>;
		HUMAN_VS_HUMAN_WORKFLOW: Workflow<Parameters<import("./src/server").HumanVsHumanWorkflow['run']>[0]['payload']>;
	}
}
