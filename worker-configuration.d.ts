/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 27387b99549a58487b51749aa4c75eaf)
...
declare namespace Cloudflare {
	...
	interface Env {
		GameAgent: DurableObjectNamespace<import("./src/server-entry").GameAgent>;
		LobbyAgent: DurableObjectNamespace<import("./src/server-entry").LobbyAgent>;
		AI: Ai;
	}
}
