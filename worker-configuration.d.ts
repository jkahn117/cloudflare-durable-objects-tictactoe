/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bc3fc2163e8f8016e0f8a1005b90519c)
// Runtime types generated with workerd@1.20251217.0 2025-09-02 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "GameManager";
	}
	interface Env {
		VITE_SERVER_URL: "tictactoe.jkahn-1.workers.dev";
		GAME_MANAGER: DurableObjectNamespace<import("./src/server").GameManager>;
		AI: Ai;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VITE_SERVER_URL">> {}
}
